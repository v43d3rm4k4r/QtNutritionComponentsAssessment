...
{
    ui->label_2->setText(tr("Введите пропорции компонента:"));
    ui->label_3->setText(tr("Введите кол-во белка на 100г компонента:"));
    ui->label_19->setText(tr("Введите кол-во липидов на 100г компонента:"));
    ui->label_20->setText(tr("Введите кол-во насыщенных жирных кислот на 100г компонента:"));
    ui->label_21->setText(tr("Введите кол-во мононенасыщенных жирных кислот на 100г компонента:"));
    ui->label_22->setText(tr("Введите кол-во полиненасыщенных жирных кислот на 100г компонента:"));
    ui->label_23->setText(tr("Введите омега-6 на 100г компонента:"));
    ui->label_24->setText(tr("Введите омега-3 на 100г компонента:"));
}
//======================================================================================================
void MainWindow::changeLabelsForMultComp()
{
    ui->label_2->setText(tr("Введите пропорции компонентов:"));
    ui->label_3->setText(tr("Введите кол-во белка на 100г каждого компонента:"));
    ui->label_19->setText(tr("Введите кол-во липидов на 100г каждого компонента:"));
    ui->label_20->setText(tr("Введите кол-во насыщенных жирных кислот на 100г каждого компонента:"));
    ui->label_21->setText(tr("Введите кол-во мононенасыщенных жирных кислот на 100г каждого компонента:"));
    ui->label_22->setText(tr("Введите кол-во полиненасыщенных жирных кислот на 100г каждого компонента:"));
    ui->label_23->setText(tr("Введите омега-6 на 100г каждого компонента:"));
    ui->label_24->setText(tr("Введите омега-3 на 100г каждого компонента:"));
}
//======================================================================================================
